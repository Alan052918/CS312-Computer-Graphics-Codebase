/**
 * Title: assignment6-lighting.cpp
 ...
 * Modification:
 * 1. Change prerpocessor statement for shader.h and camera.h
 * 2. In main() function change objectColor to SUSTech Green
 * 3. In processInput() function add support for moving camera upward and
 * downward, press "Q" to move upward, "E" to move downward
 */
#include <glad/glad.h>
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    lightingShader.use();
    lightingShader.setVec3("objectColor", 0.0f, 0.25f, 0.26f);  // SUSTech Green
...
void processInput(GLFWwindow* window) {
  ...
  // Added by Junda Ai
  // process "W" and "E" keyboard input for moving camera upward and downward
